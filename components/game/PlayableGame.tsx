  ...
  if (phase === "choosing_category") {
    return withTransition(
      <div className="flex flex-1 flex-col items-center justify-center text-center lg:pb-20">
        ...
        <h1 className="mt-2 text-[34px] font-extrabold leading-tight sm:text-[36px]">
          Alege o categorie
        </h1>
        <p className="mt-3 max-w-[580px] text-[20px] font-bold leading-snug">
        ...
        <div className="mt-9 grid w-full max-w-[688px] grid-cols-1 gap-x-[18px] gap-y-[26px] sm:grid-cols-2 lg:grid-cols-3">
